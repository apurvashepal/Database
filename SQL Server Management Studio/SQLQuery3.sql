...
insert into ShoppingCart values(50012,'Orderd',1003,1,1);
...
insert into OrderTable values(8000,1500,50001,1,10,convert(varchar, getdate(), 6));
insert into OrderTable values(8001,12000,500012,1,12,convert(varchar, getdate(), 6));          
insert into OrderTable values (8002,3000,50012,5,10,convert(varchar, getdate(), 6));
...
insert into Discount values(12,'Mansoon',10,DATEADD(month, 3, convert(varchar, getdate(), 6)));


create table ShippingDetails(ShippingId int primary key,ShipmentStatus varchar(20),OrderId int,DeliveryId int,ShipmentDate date);
insert into ShippingDetails values (225,'Orderd',8000,889,convert(varchar, getdate(), 6));
insert into ShippingDetails values(226,'Orderd',8002,889,convert(varchar, getdate(), 6));
insert into ShippingDetails values (227,'Ordered',8001,889,convert(varchar, getdate(), 6));
insert into ShippingDetails values (228,'Orderd',8000,889,convert(varchar, getdate(), 6));
